...
void analyze_hand(bool *straight, bool *flush, bool *four, bool *three,
	bool *ace_low, int *pairs, int num_in_rank[], int num_in_suit[]);
...
int main(void){
	...
	while(true){
		...
		analyze_hand(&straight, &flush, &four, &three, &ace_low, 
				&pairs, num_in_rank, num_in_suit);
		print_result(&straight, &flush, &four, &three, &ace_low, 
				&pairs);
	}
}
